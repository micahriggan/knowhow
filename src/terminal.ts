...
import { convertAudioToText } from "./conversion";

async function test() {
  const todo = await convertAudioToText("/tmp/knowhow.wav", false);
  fs.writeFileSync("/Users/micah/dev/cyg/packages/frontend/TODO.md", todo);
  /*
